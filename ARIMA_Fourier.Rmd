...
autoplot(ARIMA_Fourier_forec23) + ylab("Load")
...
#Plot forecasting results
autoplot(ARIMA_Fourier_forec24) + ylab("Load")
...
#Plot forecasting results
autoplot(ARIMA_Fourier_forec26) + ylab("Load")
...
#Plot forecasting results
autoplot(ARIMA_Fourier_forec36) + ylab("Load")
