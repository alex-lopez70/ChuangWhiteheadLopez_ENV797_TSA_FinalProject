...
library(tidyverse);library(smooth);library(zoo);library(ggthemes)
here()
```
...
```{r include=FALSE}
 ...
 theme_set(
   ...
   theme(
     ...
     plot.caption = element_text(hjust = 0.5, size = 7, face = "plain"),
...
dataset_description <- data.frame(
  ...
  Load = c("MW", "Daily", ""),
  Temperature = c("°F", "Hourly", "ERCOT Zone"),
...
ERCOT_load_summary <- data.frame(
  ...
  Description = c('Start Time for the Day (Local)', 'Start Time for the Day (UTC)',
                  'End Time for the Day (Local)', 'End Time for the Day (UTC)', 'Load (MW)',
                  'Date (YYYY-MM-DD)'),
...
ERCOT_temp_summary <- data.frame(
  ...
  Description = c('Date (YYYY-MM-DD)', 'Average Daily Temperature (°F)'),
...
ERCOT_fuelmix_summary <- data.frame(
  ...
  Description = c('Start Time for the Day (Local)', 'Start Time for the Day (UTC)',
                  'End Time for the Day (Local)', 'End Time for the Day (UTC)',
...
```{r TS ERCOT Load Plot, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="ERCOT Load from January 2017 to April 2025"}
...
```{r Load ACF, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="ACF for Load"}
# ACF for ERCOT Load
ggAcf(ts_load, lag.max = 365) + ggtitle("ACF of ERCOT Load") + theme_minimal()

```

```{r Load PACF, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="PACF for Load"}
# PACF for ERCOT Load
...
```{r Temp ACF, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="ACF for Temperature"}
# ACF for ERCOT Temperature
ggAcf(ts_temp, lag.max = 365) + ggtitle("ACF of ERCOT Temperature") + theme_minimal()

```

```{r Temp PACF, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="PACF for Temperature"}
# PACF for ERCOT Temperature
...
autoplot(ts_natural_gas, series = "Natural Gas", size = 0.5, alpha = 0.6) +
  ...
  xlab("Time") +
  ylab("Load (MW)") +
  scale_color_manual(values = c("red", "darkgreen", "skyblue2", "midnightblue", 
                                "orange", "pink")) + 
  guides(colour = guide_legend(title = "Time Series"))

```

Though all fuel mix ACFs and PACFs show non-stationary elements and seasonal components, natural gas is the most applicable to display for our ACF/PACF analysis, as the ACF and PACF of natural gas prices closely resemble those of ERCOT load and temperature, showing a gradual decay in the ACF and irregular spikes in the PACF. The shape of these plots highlights the impact of natural gas in contributing to electricity demand and makes it an important variable in scenario generation.


```{r ACF for Natural Gas, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="ACF for Natural Gas"}
# ACF for Natural Gas
ggAcf(ts_natural_gas, lag.max = 365) + ggtitle("ACF of Natural Gas") + theme_minimal()

```

```{r PACF for Natural Gas, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="PACF for Natural Gas"}
# PACF for Natural Gas
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from STL + ETS"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Observed Data and Forecasting Results from STL + ETS"}
#model + observed data
autoplot(ts_load) +
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from TBATS"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Observed Data and Forecasting Results from TBATS"}
#model + observed data
autoplot(ts_load) +
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from ARIMA+Fourier with K=c(2,3)"}
#AF23
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from ARIMA+Fourier with K=c(2,4)"}
#AF24
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from ARIMA+Fourier with K=c(2,6)"}
#AF26
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from ARIMA+Fourier with K=c(3,6)"}
#AF36
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Observed Data and Forecasting Results from AF23, AF24, AF26, AF36 Models"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from Neural Network with K=c(2,4)"}
#NN24
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from Neural Network with K=c(2,6)"}
#NN26
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from Neural Network with K=c(3,6)"}
#NN36
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Observed Data and Forecasting Results from NN24, NN26, NN36 Models"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Residuals (SARIMA)"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from SARIMA"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Residuals (SSES)"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from SS Exponential Smoothing"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Residuals (SSBSM)"}
...
```{r, echo=FALSE, fig.height=3.5, fig.width=10, message=FALSE, warning=FALSE, fig.cap="Forecasting Results from SS Basic Structure Model"}
...
```{r, echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE, fig.cap="ERCOT Load Scenario Generation"}
...
*ChatGPT was used for troubleshooting code syntax and working through sections of scenario generation as this was newer material. All models and forecasts were executed and validated locally in RStudio by the authors.*