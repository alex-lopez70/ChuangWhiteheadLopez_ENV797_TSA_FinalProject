...
autoplot(ts_natural_gas, series = "Natural Gas", size = 0.3, alpha = 0.6) +
  autolayer(ts_coal_and_lignite, series = "Coal and Lignite", size = 0.5, alpha = 0.6) +
  autolayer(ts_hydro, series = "Hydro", size = 0.3, alpha = 0.6) +
  autolayer(ts_nuclear, series = "Nuclear", size = 0.5, alpha = 0.6) +
  ...
  xlab("Time") +
  ylab("Load (MW)") +
  scale_color_manual(values = c("darkgreen", "red", "skyblue2", "midnightblue", "orange", "pink")) + 
  theme_minimal() +
