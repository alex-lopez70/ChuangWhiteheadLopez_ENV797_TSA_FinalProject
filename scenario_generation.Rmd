...
# Fit ARIMA + Fourier model with exogenous variables
fit_arima_fourier <- auto.arima(ts_load_train_transformed, seasonal = FALSE, xreg = as.matrix(xreg_full))

# Forecast horizon and number of scenarios
horizon <- 365 #data is daily, so forecasting the next 365 days
nscen <- 10
...
# Add test data as a red line on top
lines(ts_load_test, col = "red", lwd = 2, lty = 2)
